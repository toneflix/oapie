...
This creates `openapie.config.js` in the current directory with the default settings.

## Programmatic Usage

If you want to use OPENAPIE without the CLI, install it as a dependency and import from `openapie`:
