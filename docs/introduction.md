...
OAPIEX is a CLI and library for extracting API operation data from documentation sites powered by ReadMe. It can:
...
- run inside your own scripts through the `oapiex` package API
...
- Use the programmatic API when you want to load, extract, crawl, or transform pages inside your own scripts or tooling via `import { ... } from 'oapiex'`.
